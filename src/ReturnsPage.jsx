...
export default function ReturnsPage() {
  ...
  const SECTIONS = [
    ...
    { h: tr("ret.s5.h", "5. Return shipping costs"), b: tr("ret.s5.b", "You pay return shipping. We provide a return address in the Netherlands, so you never ship back to China. Within the EU that's usually €5–€8; from the UK, USA, Canada, Australia or Norway typically €10–€25, depending on the carrier. Return within 14 days of your request.") },
