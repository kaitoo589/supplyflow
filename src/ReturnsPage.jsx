...
export default function ReturnsPage() {
  ...
  const SECTIONS = [
    ...
    { h: tr("ret.s2.h", "2. Your 14-day right of withdrawal"), b: tr("ret.s2.b", "As an EU consumer you may withdraw within 14 days without giving a reason. The 14 days start the day you receive the item — not the order day. Because items ship from China, your window begins when the parcel arrives. You may also withdraw before it arrives.") },
    ...
    { h: tr("ret.s5.h", "5. Return shipping costs"), b: tr("ret.s5.b", "You pay return shipping. We provide a return address in the Netherlands, so you never ship back to China. Return within 14 days of your request.") },
