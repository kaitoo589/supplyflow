...
1.12 **"Host"** — the Flowva Friends group member designated to receive the combined parcel.

1.13 **"Returns Policy"** — Flowva's separate policy on the right of withdrawal and returns, available on the Platform and incorporated into these Terms by reference (see section 11).

1.14 **"Privacy Policy"** — Flowva's separate policy describing how we handle your personal data, available on the Platform.
...
3.1 To create an Account and place Orders you must be at least **18 years old** (or the age of majority in your country of residence, if higher) and have the legal capacity to enter into a binding contract.
...
## 13. Flowva Friends (group buying)
...
14.1 You agree to use the Platform lawfully and honestly. You must not:
- provide false information, impersonate others, or use someone else's payment method without authority;
- use the Platform or your Balance for money laundering, fraud, resale-for-business in breach of these Terms, or any unlawful purpose;
- buy Products that are illegal to import into your country, or circumvent export/sanctions rules;
...
15.1 **Nothing excluded that cannot be excluded.** Nothing in these Terms limits or excludes our liability where it would be unlawful to do so. In particular, we do **not** exclude or limit your **non-excludable statutory consumer rights**, our liability for death or personal injury caused by our negligence, for fraud or fraudulent misrepresentation, or under the legal guarantee of conformity.

15.2 **Within those limits.** Subject to section 15.1 and to mandatory law, we are responsible for foreseeable loss and damage caused by our breach of these Terms or our negligence. We are **not** responsible for loss or damage that is not foreseeable, that is caused by events beyond our reasonable control (see section 15.4), or that arises from your own breach of these Terms or incorrect information you provided.
...
16.1 The Platform and its content — including the Flowva name and logo, text, design, graphics, software and arrangement — are owned by or licensed to Flowva and protected by intellectual-property laws. You may use the Platform only for placing and managing your own Orders.
...
18.1 We may update these Terms from time to time, for example to reflect changes in our service, our fees, or the law. The current version is always available on the Platform, with the "Last updated" date.

18.2 **The Terms that apply to your Order are the version in force when you place that Order.** Changes do not apply retroactively to Orders already confirmed. For continuing aspects (such as your Account and Balance), we will give you reasonable notice of material changes, and your continued use after the changes take effect means you accept them. If you do not accept a material change, you may stop using the Platform and request a refund of your unused Balance under section 5.6.
...
20.1 **Severability.** If any provision of these Terms is found invalid or unenforceable, the rest remains in force, and the invalid provision is replaced by a valid one that comes closest to its intended meaning — without reducing your mandatory consumer rights.

20.2 **No waiver.** If we do not enforce a right under these Terms, that is not a waiver of that right.
